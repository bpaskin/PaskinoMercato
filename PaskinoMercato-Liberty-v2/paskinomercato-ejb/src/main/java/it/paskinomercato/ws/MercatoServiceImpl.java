 ...
 */
@WebService(endpointInterface = "it.paskinomercato.ws.MercatoServiceSEI",
...
public class MercatoServiceImpl implements MercatoServiceSEI {
    ...
    public String getProdottoXml(String codice) {
        try {
            ...
            throw new WebServiceException("getProdottoXml failed: " + e.getMessage(), e);
        }
    }
    ...
    public String getStatoOrdine(String numeroOrdine) {
        try {
            ...
            throw new WebServiceException("getStatoOrdine failed: " + e.getMessage(), e);
        }
    }
    ...
    public String getCategorieXml() {
        try {
            ...
            throw new WebServiceException("getCategorieXml failed: " + e.getMessage(), e);
        }
    }
