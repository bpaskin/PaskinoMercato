...
public class MailBean implements SessionBean {
    ...
    private jakarta.mail.Session getMailSession() throws Exception {
        InitialContext ic = new InitialContext();
        return (jakarta.mail.Session) ic.lookup("java:comp/env/mail/MercatoMail");
    }
    ...
    public void inviaConfermaOrdine(Cliente cliente, Ordine ordine, List<RigaOrdine> righe, String lingua) {
        ...
        try {
            InitialContext ic = new InitialContext();
            javax.sql.DataSource ds = (javax.sql.DataSource) ic.lookup("java:comp/env/jdbc/MercatoDB");
    ...
    private void sendEmail(String to, String subject, String htmlBody) {
        try {
            jakarta.mail.Session mailSession = getMailSession();
