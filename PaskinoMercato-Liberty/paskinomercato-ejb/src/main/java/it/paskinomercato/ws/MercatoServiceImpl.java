...
/**
 * JAX-RPC Service Endpoint Implementation.
...
public class MercatoServiceImpl implements MercatoServiceSEI {
    ...
    public String getProdottoXml(String codice) throws RemoteException {
        try {
            ...
            throw new RemoteException("getProdottoXml failed: " + e.getMessage(), e);
        }
    }

    public String getStatoOrdine(String numeroOrdine) throws RemoteException {
        try {
            ...
            throw new RemoteException("getStatoOrdine failed: " + e.getMessage(), e);
        }
    }

    public String getCategorieXml() throws RemoteException {
        try {
            ...
            throw new RemoteException("getCategorieXml failed: " + e.getMessage(), e);
        }
    }
